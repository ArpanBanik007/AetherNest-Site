        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            <p className="text-lg text-rich-dark/50 max-w-lg mb-12 leading-relaxed font-medium">
              Find your perfect property in the most prestigious locations across the UAE. Elite listings, verified agents, and seamless discovery.
            </p>

            {/* Quick Stats */}
            <div className="flex gap-12 pt-4 border-t border-gray-50">
              <div>
                <div className="text-2xl font-bold text-rich-dark">2,850+</div>
                <div className="text-[10px] text-rich-dark/30 font-bold uppercase tracking-widest mt-1">Listings</div>
              </div>
              <div className="w-[1px] h-10 bg-gray-100" />
              <div>
                <div className="text-2xl font-bold text-rich-dark">1,200+</div>
                <div className="text-[10px] text-rich-dark/30 font-bold uppercase tracking-widest mt-1">Agents</div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="bg-white rounded-[3rem] p-12 shadow-premium border border-gray-50 relative overflow-hidden">
              ...
              <div className="flex gap-2 mb-10 p-1.5 bg-gray-50 rounded-2xl">
                <button className="flex-1 py-4 rounded-xl bg-white text-[11px] font-bold text-rich-dark shadow-premium uppercase tracking-widest">Buy</button>
                <button className="flex-1 py-4 rounded-xl hover:bg-white/50 text-[11px] font-bold text-rich-dark/30 transition-all uppercase tracking-widest">Rent</button>
              </div>
